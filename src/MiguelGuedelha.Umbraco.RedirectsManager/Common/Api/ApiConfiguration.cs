...
internal static class ApiConfiguration
{
    extension(IUmbracoBuilder builder)
    {
        public IUmbracoBuilder AddApiCommonModule()
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                opt.SwaggerDoc(Constants.Api.ApiName, new OpenApiInfo
                {
                    Title = Constants.Api.DocTitle,
                    Version = Constants.Api.Versions.V1,
    ...
    public class CustomOperationHandler : OperationIdHandler
    {
        ...
        {
            return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith(Constants.Api.ControllersNamespace, comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
        }
