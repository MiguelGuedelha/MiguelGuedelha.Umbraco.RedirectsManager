...
namespace MiguelGuedelha.Umbraco.RedirectsManager.Composers
{
    public class MiguelGuedelhaUmbracoRedirectsManagerApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Miguel Guedelha Umbraco Redirects Manager Backoffice API",
                    Version = "1.0",
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("MiguelGuedelha.Umbraco.RedirectsManager.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
