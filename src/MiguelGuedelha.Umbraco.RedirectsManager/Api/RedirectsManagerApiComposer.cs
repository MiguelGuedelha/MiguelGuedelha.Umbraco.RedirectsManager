...
public class RedirectsManagerApiComposer : IComposer
{
    public void Compose(IUmbracoBuilder builder)
    {
        ...
        builder.Services.Configure<SwaggerGenOptions>(opt =>
        {
            ...
            opt.SwaggerDoc(RedirectsManagerApiConstants.ApiName, new OpenApiInfo
            {
                Title = RedirectsManagerApiConstants.DocTitle,
                Version = RedirectsManagerApiConstants.Versions.V1,
            ...
            opt.OperationFilter<MiguelGuedelhaUmbracoRedirectsManagerOperationSecurityFilter>();
        });
    }

    public class MiguelGuedelhaUmbracoRedirectsManagerOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
    {
        protected override string ApiName => RedirectsManagerApiConstants.ApiName;
    }
    ...
    public class CustomOperationHandler : OperationIdHandler
    {
        ...
        {
            return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith(RedirectsManagerApiConstants.ControllersNamespace, comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
        }
